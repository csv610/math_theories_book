...
\bibitem{teich_ref1} J. Hubbard, \emph{Teichmuller Theory and Applications to Geometry, Topology, and Dynamics}.
\bibitem{teich_ref2} A. F. Beardon and D. Minda, \emph{The Hyperbolic Metric and Geometry}.
\bibitem{teich_ref3} L. Ahlfors, \emph{Lectures on Quasiconformal Mappings}.
\bibitem{teich_ref4} J. Hubbard, \emph{Teichmuller Theory, Volume I}.
\bibitem{teich_ref5} A. Papadopoulos, ed., \emph{Handbook of Teichmuller Theory}.
\end{thebibliography}
