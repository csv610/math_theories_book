...
\bibitem{queue_ref1} D. Gross, J. F. Shortle, J. M. Thompson, and C. M. Harris, \emph{Fundamentals of Queueing Theory}.
\bibitem{queue_ref2} L. Kleinrock, \emph{Queueing Systems, Volume 1: Theory}.
\bibitem{queue_ref3} L. Kleinrock, \emph{Queueing Systems, Volume 2: Computer Applications}.
\bibitem{queue_ref4} J. W. Cohen, \emph{The Single Server Queue}.
\bibitem{queue_ref5} J. F. C. Kingman, \emph{Heavy Traffic in Single Server Queues}.
\end{thebibliography}
