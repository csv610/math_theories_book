...
\bibitem{set_ref1} P. Halmos, \emph{Naive Set Theory}.
\bibitem{set_ref2} J. W. Dauben, \emph{Georg Cantor: His Mathematics and Philosophy of the Infinite}.
\bibitem{set_ref3} T. Jech, \emph{Set Theory}.
\bibitem{set_ref4} A. Kanamori, \emph{The Higher Infinite}.
\bibitem{set_ref5} S. Awodey, \emph{Category Theory}.
\end{thebibliography}
