...
\bibitem{operator_theory_ref1} J. B. Conway, \emph{A Course in Functional Analysis}.
\bibitem{operator_theory_ref2} P. R. Halmos, \emph{Introduction to Hilbert Space and the Theory of Spectral Multiplicity}.
\bibitem{operator_theory_ref3} J. B. Conway, \emph{A Course in Operator Theory}.
\bibitem{operator_theory_ref4} G. K. Pedersen, \emph{C*-Algebras and Their Automorphism Groups}.
\bibitem{operator_theory_ref5} K. Hoffman, \emph{Banach Spaces of Analytic Functions}.
\end{thebibliography}
