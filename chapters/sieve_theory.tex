...
\bibitem{sieve_ref1} A. C. Cojocaru and M. R. Murty, \emph{An Introduction to Sieve Methods and Their Applications}.
\bibitem{sieve_ref2} H. Halberstam and H.-E. Richert, \emph{Sieve Methods}.
\bibitem{sieve_ref3} J. Friedlander and H. Iwaniec, \emph{Opera de Cribro}.
\bibitem{sieve_ref4} J. Maynard, \emph{Small Gaps Between Primes}.
\end{thebibliography}
