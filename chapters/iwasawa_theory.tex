...
For a cyclotomic example, begin with $K=\mathbb Q(\mu_p)$ and adjoin $p^{n+1}$st roots of unity. The union $K_\infty$ has Galois group $\mathbb Z_p$ over the appropriate base. Let $I_n$ be the $p$-primary part of the ideal class group of $K_n$. Norm maps $I_m\to I_n$ form an inverse system, and $I=\varprojlim I_n$ becomes a module over the Iwasawa algebra
\[
