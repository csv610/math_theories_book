...
\item \textbf{Exercise 1. What is $a/b$ in a wheel?} It is shorthand for $a\cdot(/b)$ and is defined even if $b=0$.

\item \textbf{Exercise 2. Why can $0/0$ not simply be $1$?} That would make ordinary cancellation inconsistent with division. A wheel assigns a special value and changes the identities that would cause the contradiction.

\item \textbf{Exercise 3. What happens when $b\ne0$?} In a wheel extending the real numbers, the quotient agrees with the ordinary real quotient.

\item \textbf{Exercise 4. Why is the inverse operation unary?} Division is defined by multiplying by the inverse-like value of the denominator.

\item \textbf{Exercise 5. What problem does a total operation solve in software?} It prevents undefined intermediate expressions from crashing symbolic manipulation; exceptional results remain explicit values.

\end{enumerate}
\section*{8. References}
\begin{thebibliography}{9}
\bibitem{wheel_ref1} J. Carlstrom, \emph{Wheels: On Division by Zero}.
\bibitem{wheel_ref2} J. A. Bergstra and J. V. Tucker, \emph{The Rational Numbers as an Abstract Data Type}.
\bibitem{wheel_ref3} A. Setzer, \emph{Wheels}.
\end{thebibliography}
