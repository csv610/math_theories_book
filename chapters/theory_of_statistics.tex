...
\bibitem{statistics_ref1} D. R. Cox and D. V. Hinkley, \emph{Theoretical Statistics}.
\bibitem{statistics_ref2} E. L. Lehmann and J. P. Romano, \emph{Testing Statistical Hypotheses}.
\bibitem{statistics_ref3} W. G. Cochran, \emph{Sampling Techniques}.
\bibitem{statistics_ref4} G. Casella and R. L. Berger, \emph{Statistical Inference}.
\bibitem{statistics_ref5} D. A. Freedman, \emph{Statistical Models: Theory and Practice}.
\end{thebibliography}
