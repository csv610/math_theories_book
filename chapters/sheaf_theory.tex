...
\bibitem{sheaf_ref1} G. E. Bredon, \emph{Sheaf Theory}.
\bibitem{sheaf_ref2} R. Godement, \emph{Topologie algebrique et theorie des faisceaux}.
\bibitem{sheaf_ref3} I. Moerdijk and S. Mac Lane, \emph{Sheaves in Geometry and Logic}.
\bibitem{sheaf_ref4} R. Hartshorne, \emph{Algebraic Geometry}.
\end{thebibliography}
