...
\bibitem{trans_ref1} A. Baker, \emph{Transcendental Number Theory}.
\bibitem{trans_ref2} E. B. Burger and R. Tubbs, \emph{Making Transcendence Transparent}.
\bibitem{trans_ref3} S. Lang, \emph{Introduction to Transcendental Numbers}.
\bibitem{trans_ref4} A. Baker and G. Wustholz, \emph{Logarithmic Forms and Diophantine Geometry}.
\end{thebibliography}
