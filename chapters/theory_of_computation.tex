...
\bibitem{computation_ref1} M. Sipser, \emph{Introduction to the Theory of Computation}.
\bibitem{computation_ref2} J. E. Hopcroft, R. Motwani, and J. D. Ullman, \emph{Introduction to Automata Theory, Languages, and Computation}.
\bibitem{computation_ref3} H. Rogers, \emph{Theory of Recursive Functions and Effective Computability}.
\bibitem{computation_ref4} S. Arora and B. Barak, \emph{Computational Complexity}.
\end{thebibliography}
