...
\bibitem{singularity_ref1} V. I. Arnold, \emph{Singularities of Differentiable Maps}.
\bibitem{singularity_ref2} V. I. Arnold, \emph{Catastrophe Theory}.
\bibitem{singularity_ref3} E. Brieskorn and H. Knorrer, \emph{Plane Algebraic Curves}.
\bibitem{singularity_ref4} M. Goresky and R. MacPherson, \emph{Stratified Morse Theory}.
\end{thebibliography}
