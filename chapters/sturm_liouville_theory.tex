...
\bibitem{sturm_ref1} A. Zettl, \emph{Sturm--Liouville Theory}.
\bibitem{sturm_ref2} R. Courant and D. Hilbert, \emph{Methods of Mathematical Physics}.
\bibitem{sturm_ref3} G. Teschl, \emph{Mathematical Methods in Quantum Mechanics}.
\end{thebibliography}
