...
\bibitem{perturbation_ref1} C. M. Bender and S. A. Orszag, \emph{Advanced Mathematical Methods for Scientists and Engineers}.
\bibitem{perturbation_ref2} M. H. Holmes, \emph{Introduction to Perturbation Methods}.
\bibitem{perturbation_ref3} J. J. Sakurai and J. Napolitano, \emph{Modern Quantum Mechanics}.
\end{thebibliography}
