...
\bibitem{topology_ref1} J. R. Munkres, \emph{Topology}.
\bibitem{topology_ref2} S. Willard, \emph{General Topology}.
\bibitem{topology_ref3} A. Hatcher, \emph{Algebraic Topology}.
\bibitem{topology_ref4} J. M. Lee, \emph{Introduction to Topological Manifolds}.
\end{thebibliography}
