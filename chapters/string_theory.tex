...
\bibitem{string_ref1} J. Polchinski, \emph{String Theory, Volumes I and II}.
\bibitem{string_ref2} B. Zwiebach, \emph{A First Course in String Theory}.
\bibitem{string_ref3} M. B. Green, J. H. Schwarz, and E. Witten, \emph{Superstring Theory}.
\bibitem{string_ref4} C. V. Johnson, \emph{D-Branes}.
\bibitem{string_ref5} E. Kiritsis, \emph{String Theory in a Nutshell}.
\end{thebibliography}
