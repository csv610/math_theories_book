...
\bibitem{chaos_theory_ref1} S. H. Strogatz, \emph{Nonlinear Dynamics and Chaos}.
\bibitem{chaos_theory_ref2} R. L. Devaney, \emph{An Introduction to Chaotic Dynamical Systems}.
\bibitem{chaos_theory_ref3} E. Ott, \emph{Chaos in Dynamical Systems}.
\bibitem{chaos_theory_ref4} E. N. Lorenz, \emph{The Essence of Chaos}.
\end{thebibliography}
