...
\bibitem{approximation_theory_ref1} L. N. Trefethen, \emph{Approximation Theory and Approximation Practice}.
\bibitem{approximation_theory_ref2} G. B. Folland, \emph{Real Analysis}.
\bibitem{approximation_theory_ref4} T. J. Rivlin, \emph{Chebyshev Polynomials: From Approximation Theory to Algebra and Number Theory}.
\bibitem{approximation_theory_ref5} G. Szegő, \emph{Orthogonal Polynomials}.
\bibitem{approximation_theory_ref6} N. J. Higham, \emph{Accuracy and Stability of Numerical Algorithms}.
\bibitem{approximation_theory_ref7} N. I. Achieser, \emph{Theory of Approximation}.
\end{thebibliography}
