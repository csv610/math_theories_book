...
\bibitem{probability_theory_ref1} D. Williams, \emph{Weighing the Odds}.
\bibitem{probability_theory_ref2} S. M. Ross, \emph{A First Course in Probability}.
\bibitem{probability_theory_ref3} A. N. Kolmogorov, \emph{Foundations of the Theory of Probability}.
\end{thebibliography}
