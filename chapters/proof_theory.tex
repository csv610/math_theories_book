...
\bibitem{proof_ref1} S. Buss, ed., \emph{Handbook of Proof Theory}.
\bibitem{proof_ref2} G. Gentzen, \emph{The Collected Papers of Gerhard Gentzen}.
\bibitem{proof_ref3} S. G. Simpson, \emph{Subsystems of Second Order Arithmetic}.
\bibitem{proof_ref4} A. S. Troelstra and H. Schwichtenberg, \emph{Basic Proof Theory}.
\bibitem{proof_ref5} J.-Y. Girard, P. Taylor, and Y. Lafont, \emph{Proofs and Types}.
\end{thebibliography}
