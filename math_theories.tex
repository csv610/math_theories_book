...
\item[Category] A collection of objects together with arrows (morphisms) between them that can be composed. Categories organize mathematical structures by their shared patterns of maps.
...
\item[Functor] A map between categories that sends objects to objects and arrows to arrows while preserving composition. It transports a construction from one setting to another, such as turning a topological space into a group.
