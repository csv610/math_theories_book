...
\title{\Huge Mathematics Theories in Nutshell\\[6pt]\large A Friendly Guide to Mathematical Theories\\[4pt]\normalsize A survey with worked examples and routes for further study}
...
\paragraph{If you are new to university mathematics}
You do not need calculus, proofs, or formal notation to begin. The twelve worked modules (Modules 1--12, starting on page~\pageref{module1}) teach core ideas through small problems and guided exercises. Each module takes about 20 minutes. Do the exercises before reading the answers.

The alphabetical chapter list (starting with Algebraic Geometry) is a reference catalogue, not a reading order. Each chapter is a short map of one theory: what it studies, why it matters, and where it connects. Some chapters use definitions you may not have seen yet; the Student's Toolbox (near the end) explains the most common ones. You can read any chapter in any order and return to it later.

\paragraph{If you already know calculus and proof techniques}
Start with any chapter that interests you. The intuitive opening gives the main idea; the core theory gives the precise statement; the sample questions let you test understanding. The worked modules review the same ideas from a different angle.

\mainmatter

\part{Chapters in alphabetical order}
\input{chapters/algebraic_geometry.tex}

\input{chapters/almgren_pitts_min_max_theory.tex}

\input{chapters/approximation_theory.tex}

\input{chapters/arakelov_theory.tex}

\input{chapters/asymptotic_theory.tex}

\input{chapters/automata_theory.tex}

\input{chapters/bass_serre_theory.tex}

\input{chapters/bifurcation_theory.tex}

\input{chapters/braid_theory.tex}

\input{chapters/brill_noether_theory.tex}

\input{chapters/catastrophe_theory.tex}

\input{chapters/category_theory.tex}

\input{chapters/chaos_theory.tex}

\input{chapters/character_theory.tex}

\input{chapters/choquet_theory.tex}

\input{chapters/class_field_theory.tex}

\input{chapters/cobordism_theory.tex}

\input{chapters/coding_theory.tex}

\input{chapters/cohomology_theory.tex}

\input{chapters/continuum_theory.tex}

\input{chapters/computational_learning_theory.tex}

\input{chapters/control_theory.tex}

\input{chapters/deformation_theory.tex}

\input{chapters/dempster_shafer_theory.tex}

\input{chapters/dimension_theory.tex}

\input{chapters/distribution_theory.tex}

\input{chapters/dynamical_systems_theory.tex}

\input{chapters/elimination_theory.tex}

\input{chapters/ergodic_theory.tex}

\input{chapters/extremal_graph_theory.tex}

\input{chapters/field_theory.tex}

\input{chapters/galois_theory.tex}

\input{chapters/game_theory.tex}

\input{chapters/graph_theory.tex}

\input{chapters/group_theory.tex}

\input{chapters/hodge_theory.tex}

\input{chapters/homology_theory.tex}

\input{chapters/homotopy_theory.tex}

\input{chapters/ideal_theory.tex}

\input{chapters/index_theory.tex}

\input{chapters/information_theory.tex}

\input{chapters/intersection_theory.tex}

\input{chapters/invariant_theory.tex}

\input{chapters/iwasawa_theory.tex}

\input{chapters/k_theory.tex}

\input{chapters/knot_theory.tex}

\input{chapters/l_theory.tex}

\input{chapters/lattice_theory.tex}

\input{chapters/lie_theory.tex}

\input{chapters/matroid_theory.tex}

\input{chapters/m_theory.tex}

\input{chapters/measure_theory.tex}

\input{chapters/model_theory.tex}

\input{chapters/module_theory.tex}

\input{chapters/morse_theory.tex}

\input{chapters/nevanlinna_theory.tex}

\input{chapters/number_theory.tex}

\input{chapters/obstruction_theory.tex}

\input{chapters/operator_theory.tex}

\input{chapters/order_theory.tex}

\input{chapters/percolation_theory.tex}

\input{chapters/perturbation_theory.tex}

\input{chapters/probability_theory.tex}

\input{chapters/proof_theory.tex}

\input{chapters/queue_theory.tex}

\input{chapters/ramsey_theory.tex}

\input{chapters/random_matrix_theory.tex}

\input{chapters/representation_theory.tex}

\input{chapters/ring_theory.tex}

\input{chapters/scheme_theory.tex}

\input{chapters/semigroup_theory.tex}

\input{chapters/set_theory.tex}

\input{chapters/shape_theory.tex}

\input{chapters/sheaf_theory.tex}

\input{chapters/sieve_theory.tex}

\input{chapters/singularity_theory.tex}

\input{chapters/soliton_theory.tex}

\input{chapters/spectral_theory.tex}

\input{chapters/string_theory.tex}

\input{chapters/sturm_liouville_theory.tex}

\input{chapters/surgery_theory.tex}

\input{chapters/teichm_ller_theory.tex}

\input{chapters/theory_of_computation.tex}

\input{chapters/theory_of_equations.tex}

\input{chapters/theory_of_statistics.tex}

\input{chapters/topology.tex}

\input{chapters/topos_theory.tex}

\input{chapters/transcendental_number_theory.tex}

\input{chapters/twistor_theory.tex}

\input{chapters/type_theory.tex}

\input{chapters/wheel_theory.tex}
...
This short dictionary is meant to be used while reading. The point is not to avoid precise ideas, but to give each precise idea a familiar handle. If you meet a term not listed here, it will be defined in the chapter where it first appears.
...
\item[Measure] A rule for assigning a size (length, area, volume, or probability) to sets. A fair die assigns measure $1/6$ to each face.
...
\paragraph{Advanced terms you will meet later.}
Some chapters use terms that require more background than this introduction provides. You will meet them again when you study those subjects in a full course:
\begin{description}[leftmargin=3.0cm,style=nextline]
\item[Category] A collection of objects together with arrows between them that can be composed. It organizes mathematical structures by their shared patterns of maps.
\item[Functor] A map between categories that preserves their structure. It transports a construction from one setting to another.
\item[Sigma-algebra] A collection of subsets that is closed under complements and countable unions. It tells you which sets are allowed to have a measure assigned to them.
\item[Wheel] An algebraic system designed to let division by zero be written as a total operation.
\end{description}
...
\end{enumerate}
Then explain the theory to another person---or write the explanation in a message to a friend, or say it out loud to yourself---without using its name. If the explanation still works, you understand the idea rather than merely recognizing the vocabulary. After that, the equations will make more sense when you see them.

\chapter*{A map of the connections}
This section is a reference guide. Read it after finishing the modules, when the theory names will be familiar.
...
\item[Read now (no calculus needed)] Courant and Robbins, \emph{What Is Mathematics?}; Ian Stewart, \emph{Concepts of Modern Mathematics}.
\item[Read after one semester] Daniel Velleman, \emph{How to Prove It}; Richard Johnsonbaugh, \emph{Discrete Mathematics}.
\item[Needs probability or statistics] David Williams, \emph{Weighing the Odds}; David Freedman, Robert Pisani, and Roger Purves, \emph{Statistics}.
\item[Needs calculus] Michael Spivak, \emph{Calculus} (honours level); Walter Strauss, \emph{Partial Differential Equations}.
\item[Needs one year of university math] Joseph Gallian, \emph{Contemporary Abstract Algebra}; G.\,H.\ Hardy and E.\,M.\ Wright, \emph{An Introduction to the Theory of Numbers}.
\item[Topology: accessible first] Sidney Morris, \emph{Topology Without Tears} (free online); James Munkres, \emph{Topology} (standard reference).
\item[Computation: intermediate] Michael Sipser, \emph{Introduction to the Theory of Computation}; Thomas Cover and Joy Thomas, \emph{Elements of Information Theory}.
\item[Graduate level (third year or later)] Serge Lang, \emph{Algebra}; Robin Hartshorne, \emph{Algebraic Geometry}; John Lee, \emph{Introduction to Smooth Manifolds}. These are reference texts, not assumed prerequisites for this book.
\end{description}
